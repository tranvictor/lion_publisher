...
ActiveRecord::Schema.define(:version => 20141222002956) do
  ...
  add_index "clicks", ["ip", "session_id"], :name => "index_clicks_on_ip_and_session_id", :unique => true
  ...
  add_index "comments", ["upload_image_id"], :name => "index_comments_on_upload_image_id"
  ...
  add_index "likes", ["upload_image_id"], :name => "index_likes_on_upload_image_id"
  add_index "likes", ["user_id", "upload_image_id"], :name => "index_likes_on_user_id_and_upload_image_id", :unique => true
  ...
  create_table "page_views", :force => true do |t|
    ...
    t.date     "date"
    t.float    "number_new",   :default => 0.0
  end

  add_index "page_views", ["session_id"], :name => "index_page_views_on_session_id", :unique => true
  ...
  add_index "pages", ["page_no"], :name => "index_pages_on_page_no"
  ...
  add_index "visitors", ["ip"], :name => "index_visitors_on_ip", :unique => true
