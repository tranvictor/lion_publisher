          ...
          columnDefs: [
            {
              render: function(data, type, row) {
                return '<a href="/articles/' + row.id + '/edit"><div class="image" style="background-image: url(' + 'http://192.168.1.160:3000/' + data + ')"></div></a>';
              },
              targets: 1
            }, {
              render: function(data, type, row) {
                ...
                return '<h4 class="title"><a href="/articles/' + row.id + '/edit">' + data + '</a></h4>' + '<p class="' + publishedClass + '"></p>' + '<p class="description">' + row.desc + '</p>';
              },
              targets: 2
            }, {
              render: function(data, type, row) {
